...
export const metadata = {
  title: "Game Development Projects - LowScarlet",
  description: "Play and explore interactive web games developed by Tegar Maulana Fahreza.",
};
  ...
  return (
    <div className="flex flex-col max-w-2xl">
      <div className="top-0 z-10 sticky flex justify-between items-center bg-[#101010] p-4">
        <h1 className="z-0 flex items-center space-x-2"><FaRegFolder /><span>Game Developments</span></h1>
