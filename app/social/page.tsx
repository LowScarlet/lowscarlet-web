...
export default function SocialPage() {
  ...
  return (
    <div className="flex flex-col max-w-2xl bg-[#090909] border border-neutral-900 rounded-2xl min-h-[80vh] my-8 mx-auto text-neutral-100 overflow-hidden shadow-xl">
      {/* Header */}
      ...
      <div className="flex-1 flex flex-col min-h-0 bg-[#070707]">
        {activeTab === 'comments' ? (
          <>
            <div className="flex-1 overflow-y-auto p-5 space-y-4 max-h-[400px] scrollbar-thin scrollbar-thumb-neutral-800 scrollbar-track-transparent">
          ...
          <div className="flex-1 overflow-y-auto p-5 space-y-3 max-h-[500px] scrollbar-thin scrollbar-thumb-neutral-800 scrollbar-track-transparent">
