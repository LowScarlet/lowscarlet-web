...
export default function SocialPage() {
  ...
  return (
    <div className="relative flex flex-col max-w-2xl bg-[#090909] border border-neutral-900 rounded-2xl h-[80vh] my-8 mx-auto text-neutral-100 overflow-hidden shadow-xl">
      {/* Header */}
            ...
            >
              ...
              <div className="space-y-3">
                <input
                  ...
                  className="w-full bg-neutral-950 border border-neutral-855 focus:border-violet-500 rounded-lg px-3 py-1.5 text-xs placeholder-neutral-500 focus:outline-hidden transition duration-200"
                />
